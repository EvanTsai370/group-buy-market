...
public class AdminOrderController {
    ...
    public Result<PageResult<AdminTradeOrderResponse>> listOrders(
        ...
        PageResult<TradeOrderResult> result = adminOrderService.listTradeOrders(page, size,
        ...
        PageResult<AdminTradeOrderResponse> pageResponse = new PageResult<>(
